...
normal_df = pd.read_csv("Result/normal_N_vary.csv")
normal_df["time_s"] = normal_df["time_ms"] / 1000
anam_df = pd.read_csv("Result/anamorphic_N_vary.csv")
...
plt.savefig("Result/BS_VaryN_Bar.pdf", format='pdf', bbox_inches='tight', dpi=300)
plt.show()
